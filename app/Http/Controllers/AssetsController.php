...
class AssetsController extends Controller
{
    ...
    public function update(Request $request, $no_assets)
    {
        ...
        try{
            ...
            if ($request->tempVendorAkhir != null && $request->tanggal_pemindahan != null) {
                Riwayat::create([
                    ...
                    'TanggalPemindahan' => $request->tanggal_pemindahan,
                ]);
            ...
            Alert::error('Update Failed', 'There was an error during Update: ' . $e->getMessage());
        }
    }
